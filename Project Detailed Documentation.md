...
The Streamlit app in `app.py` is the public user-facing dashboard. It:
...
This project already includes compatibility handling to reduce breakage from older scikit-learn pickle formats, including a compatibility shim for the legacy `_loss` module in `app.py`.
